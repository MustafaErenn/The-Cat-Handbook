...
extension MediaQueryExtension on BuildContext {
  ...
  double get webValueHorizontal => width * 0.30;
}
...
extension PaddingExtensionOnly on BuildContext {
  ...
  EdgeInsets get paddingTopNormal => EdgeInsets.only(top: normalValue);
  EdgeInsets get paddingTopMedium => EdgeInsets.only(top: mediumValue);
...
extension PaddingExtensionSymetric on BuildContext {
  ...
  EdgeInsets get paddingWebHorizontal => EdgeInsets.symmetric(horizontal: webValueHorizontal);
}
...
extension DurationExtension on BuildContext {
  Duration get veryLowDuration => const Duration(milliseconds: 250);
